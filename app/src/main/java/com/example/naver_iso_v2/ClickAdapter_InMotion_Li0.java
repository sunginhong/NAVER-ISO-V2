...
public class ClickAdapter_InMotion_Li0 implements View.OnClickListener{
    ...
    public ClickAdapter_InMotion_Li0(Context context){
        mContext = context;
    }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.in_motion_li0_btncase0:
                Vars_Def.inMotion_li0_state = 200;
                duration = 0.2;
                Pannel_ListLayout_InMotion.in_motion_li0_btncase0_text.setTextColor(Color.parseColor("#000000"));
                ...
                Pannel_ListLayout_InMotion.in_motion_li0_btncase0_radio_trans.startTransition(100);
            ...
            case R.id.in_motion_li0_btncase1:
                Vars_Def.inMotion_li0_state = 300;
                duration = 0.3;
                ...
                Pannel_ListLayout_InMotion.in_motion_li0_btncase1_radio_trans.startTransition(100);
                Pannel_ListLayout_InMotion.in_motion_li0_btncase2_radio_trans.resetTransition();
                break;

            case R.id.in_motion_li0_btncase2:
                Vars_Def.inMotion_li0_state = 400;
                duration = 0.4;
                Pannel_ListLayout_InMotion.in_motion_li0_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_InMotion.in_motion_li0_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_InMotion.in_motion_li0_btncase2_text.setTextColor(Color.parseColor("#000000"));
                Pannel_ListLayout_InMotion.in_motion_li0_btncase0_radio_trans.resetTransition();
                Pannel_ListLayout_InMotion.in_motion_li0_btncase1_radio_trans.resetTransition();
