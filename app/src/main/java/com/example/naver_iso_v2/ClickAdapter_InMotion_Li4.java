    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.in_motion_li4_btncase0:
                idx = 0;
                Vars_Def.group1_li4_state = Vars_Def.array_string_easeType[idx];
//                Pannel_ListLayout_InMotion.result_in_ease.setText("cubic-bezier(0.32, 0, 0.67, 0)");
            ...
            case R.id.in_motion_li4_btncase1:
                idx = 1;
                Vars_Def.group1_li4_state = Vars_Def.array_string_easeType[idx];
//                Pannel_ListLayout_InMotion.result_in_ease.setText("cubic-bezier(0.65, 0, 0.35, 1)");
            ...
            case R.id.in_motion_li4_btncase2:
                idx = 2;
                Vars_Def.group1_li4_state = Vars_Def.array_string_easeType[idx];
//                Pannel_ListLayout_InMotion.result_in_ease.setText("cubic-bezier(0.33, 1, 0.68, 1)");
                Pannel_ListLayout_InMotion.in_motion_li4_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_InMotion.in_motion_li4_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
            ...
            case R.id.in_motion_li4_btncase3:
                idx = 3;
                Vars_Def.group1_li4_state = Vars_Def.array_string_easeType[idx];
//                Pannel_ListLayout_InMotion.result_in_ease.setText("cubic-bezier(0.34, 1.56, 0.64, 1)");
                Pannel_ListLayout_InMotion.in_motion_li4_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_InMotion.in_motion_li4_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_InMotion.in_motion_li4_btncase2_text.setTextColor(Color.parseColor("#BDC0BD"));
        ...
        AnimRectObject.function_group1_selEase(Vars_Def.group1_li4_state);
