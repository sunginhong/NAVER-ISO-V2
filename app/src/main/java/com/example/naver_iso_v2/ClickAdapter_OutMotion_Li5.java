...
public class ClickAdapter_OutMotion_Li5 implements View.OnClickListener{

    Context mContext;

    public ClickAdapter_OutMotion_Li5(Context context){
        mContext = context;
    }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.out_motion_li5_btncase0:
                Vars_Def.outMotion_li5_state = "None";
                ...
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase0_radio_trans.startTransition(100);
            ...
            case R.id.out_motion_li5_btncase1:
                Vars_Def.outMotion_li5_state = "Light";
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase1_text.setTextColor(Color.parseColor("#000000"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase2_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase3_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase0_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase1_radio_trans.startTransition(100);
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase2_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase3_radio_trans.resetTransition();
                break;
            ...
            case R.id.out_motion_li5_btncase2:
                ...
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase0_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase1_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase2_radio_trans.startTransition(100);
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase3_radio_trans.resetTransition();
                break;
            ...
            case R.id.out_motion_li5_btncase3:
                ...
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase2_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase3_text.setTextColor(Color.parseColor("#000000"));
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase0_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase1_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase2_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li5_btncase3_radio_trans.startTransition(100);
                break;
        }
