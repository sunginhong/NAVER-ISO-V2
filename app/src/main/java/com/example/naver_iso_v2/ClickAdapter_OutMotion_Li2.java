...
public class ClickAdapter_OutMotion_Li2 implements View.OnClickListener{

    Context mContext;

    public ClickAdapter_OutMotion_Li2(Context context){
        mContext = context;
    }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.out_motion_li2_btncase0:
                Vars_Def.outMotion_li2_state = 0.0;
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase0_text.setTextColor(Color.parseColor("#000000"));
                ...
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase0_radio_trans.startTransition(100);
            ...
            case R.id.out_motion_li2_btncase1:
                Vars_Def.outMotion_li2_state = 0.5;
                ...
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase1_radio_trans.startTransition(100);
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase2_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase3_radio_trans.resetTransition();
                break;

            case R.id.out_motion_li2_btncase2:
                Vars_Def.outMotion_li2_state = 0.7;
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase2_text.setTextColor(Color.parseColor("#000000"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase3_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase0_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase1_radio_trans.resetTransition();
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase2_radio_trans.startTransition(100);
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase3_radio_trans.resetTransition();
                break;

            case R.id.out_motion_li2_btncase3:
                Vars_Def.outMotion_li2_state = 1;
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase0_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase1_text.setTextColor(Color.parseColor("#BDC0BD"));
                Pannel_ListLayout_OutMotion.out_motion_li2_btncase2_text.setTextColor(Color.parseColor("#BDC0BD"));
